...
RUN echo "deb http://ppa.launchpad.net/sentry/sentry/ubuntu focal main" > /etc/apt/sources.list.d/sentry.list \
    && gpg --keyserver keyserver.ubuntu.com --recv-keys 4096R/90A6F6E5A19FC22CED8BFAD73EB114CF19617013 \
    && gpg --export --armor 4096R/90A6F6E5A19FC22CED8BFAD73EB114CF19617013 | apt-key add -
